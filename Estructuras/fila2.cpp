...
//Funcion para buscar el numero repetido
int busca (int v) {
	//Variables
	int f=1;
	struct nodo *ap;
	ap=inicio;
	//Verifica el numero repetido
...
//Funcion Para insertar en la fila 
void inserta (int n) {
...
//Funcion Para Borra el numero en la lista 
int borra (int n) {
	int r=-1, band=1;
	struct nodo *ap1, *ap2;
	band=busca(n);
	...
	do
	{
		...
		switch(op)
		{
			...
			case '2': cout<<"\nQue numero desea borrar? ";
					  ...
					  num=borra(num);
					  if(num!=r)
					      cout<<"\nEl numero no esta en la Lista cawn! \n";
					  break;
			case '3': muestra();		            
		}
	}
